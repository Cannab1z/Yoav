...
<body style="font-size: 0.8em; color: black; font-family: Arial; direction: rtl;">
    ...
    <tr><td>
        ...
        <table>
        <tr>
        <td width="100" style="background-color:#003C79; height: 18px;"><asp:Label ID="table1" runat="server" Text="שם משתמש" ForeColor="White"></asp:Label></td>
        <td width="100" style="background-color:gainsboro; height: 18px;"><asp:Label ID="Label2" runat="server" Text="שם פרטי"></asp:Label></td>
        <td width="100" style="background-color:#003C79; height: 18px;"><asp:Label ID="Label3" runat="server" Text="שם משפחה" ForeColor="White"></asp:Label></td>
        <td width="100" style="background-color:gainsboro; height: 18px;"><asp:Label ID="Label4" runat="server" Text="מקום מגורים"></asp:Label></td>
        <td width="100" style="background-color:#003C79; height: 18px;"><asp:Label ID="Label5" runat="server" Text="סיסמא" ForeColor="White"></asp:Label></td>
        <td width="70" style="background-color:gainsboro; height: 18px;"><asp:Label ID="Label6" runat="server" Text="עריכת פרטים"></asp:Label></td>
        <td width="70" style="background-color:#003C79; height: 18px;"><asp:Label ID="Label1" runat="server" Text="מחיקה מהאתר" ForeColor="White"></asp:Label></td>
        </tr>
